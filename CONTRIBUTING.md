...
* Please **do not** use the issue tracker for personal support requests (use the
  [SMC Discourse](http://discourse.roots.io/)).
...
3. **Isolate the problem to SMC** &mdash; make sure that the code in the SMC
...
fits with the scope and aims of SMC. It's up to *you* to make a strong
case to convince the SMC developers of the merits of this feature. Please
...
time working on something that the developers might not want to merge into SMC.
...
1. [Fork](http://help.github.com/fork-a-repo/) SMC, clone your fork,
